      ...
      <table width="801" height="436" border="0" cellpadding="0" cellspacing="0" background="images/center2.jpg">
        <tr>
          <td height="436" valign="top" align="center">           <html:form action="department.do?method=insertDepartment" onsubmit="return checkEmptyForm(departmentForm)">          
            <table width="355" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#3f13ec">
              <tr>
                <th width="79" height="30"><span class="word_white">部门名称：</span></th>
                <td width="263" bgcolor="#0e047d"><html:text property="dt_name" title="请输入部门名称"/></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td bgcolor="#0e047d"><html:text property="dt_bz" title="请输入部门备注信息"/></td>
              </tr>
            </table><br>         
