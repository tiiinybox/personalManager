    ...
    <td align="center">
      ...
      <table width="801" height="436" border="0" cellpadding="0" cellspacing="0" background="images/center2.jpg">
        ...
        <html:form action="inviteJob.do?method=insertInviteJob" onsubmit="return checkEmptyForm(inviteJobForm)">  
          <table width="493" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#0e047d">
            <tr>
              <th width="69" height="30" class="word_white">姓名：</th>
              <td width="166" bgcolor="#0e047d"><html:text property="name" title="请输入应聘人姓名"/></td>
              <th width="67" class="word_white">性别：</th>
              <td width="171" bgcolor="#0e047d">&nbsp;&nbsp;<html:radio property="sex" value="男" styleClass="input1" />&nbsp;男&nbsp;&nbsp;&nbsp;&nbsp;<html:radio property="sex" value="女" styleClass="input1"/>&nbsp;女</td>
            </tr>
            <tr>
              <th height="30" class="word_white">年龄：</th>
              <td bgcolor="#0e047d"><html:text property="age" title="请输入应聘人年龄"/></td>
              <th class="word_white">出生日期：</th>
              <td bgcolor="#0e047d"><html:text property="born" title="请输入出生日期"/></td>
            </tr>
            <tr>
              <th height="30" class="word_white">应聘职位：</th>
              <td bgcolor="#0e047d"><html:text property="job" title="请输入应聘职务"/></td>
              <th class="word_white">所学专业：</th>
              <td bgcolor="#0e047d"><html:text property="specialty" title="请输入所学专业"/></td>
            </tr>
            <tr>
              <th height="30" class="word_white">工作经验：</th>
              <td bgcolor="#0e047d"><html:text property="experience" title="请输入工作经验"/></td>
            ...
            <tr>
              ...
              <td bgcolor="#0e047d"><html:text property="tel" title="请输入联系电话"/></td>
              <th class="word_white">毕业学校：</th>
              <td bgcolor="#0e047d"><html:text property="afterSchool" title="请输入毕业学校"/></td>
            </tr>
            <tr>
              <th height="30" class="word_white">家庭住址：</th>
              <td bgcolor="#0e047d"><html:text property="address" title="请输入家庭住址"/></td>
              <th class="word_white">登记时间：</th>
              <td bgcolor="#0e047d"><html:text property="createtime" value="<%=getSystemTime.getToday()%>" readonly="readonly" onclick="alert('此文本框已设为只读，用户不能修改')"/></td>
            </tr>
            <tr>
              <th height="111" class="word_white">个人简介:<html:hidden property="isstock" value="0"/></th>
              <td colspan="3" bgcolor="#0e047d"><html:textarea property="content" rows="8" styleClass="textarea" cols="50" title="请输入个人简介"/></td>
            </tr>
          </table>
          <br>
