...
out.print("<script language=javascript>alert('请重新登陆');window.location.href='index.jsp';</script>");
}else{
...
<table width="801" height="34" border="0" cellpadding="0" cellspacing="0" background="images/top.jpg">
        <tr>
          <td width="532" align="right" valign="top">
		  <table width="224" border="0" align="right" cellpadding="0" cellspacing="0">
            <tr>
              <td width="206" height="30" valign="bottom" align="right"><font color="#666633">登陆时间：<%=getSystemTime.getToday()%></font></td>
              <td width="10">&nbsp;</td>
            </tr>
          </table>         
	      </td>
