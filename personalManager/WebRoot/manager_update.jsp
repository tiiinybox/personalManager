      ...
      <table width="801" height="436" border="0" cellpadding="0" cellspacing="0" background="images/center2.jpg">
        <tr>
		 ...
		 <html:form action="manager.do?method=updateManager" onsubmit="return updatePasswordManager()">
		  <table width="400" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#0e047d">
            <tr>
              <th width="100" height="30"><span class="word_white">账&nbsp;&nbsp;号：</span></th>
              <td width="287" bgcolor="#0e047d">${sessionScope.managerform.account}<html:hidden property="account" value="${sessionScope.managerform.account}"/></td>
            </tr>
            <tr>
              <th height="30"><span class="word_white">旧密码：</span></th>
              <td bgcolor="#0e047d"><input name="oldPassword1" type="password" size="30"><input name="oldPassword2" type="hidden" value="${sessionScope.managerform.password}"></td>
            </tr>
            <tr>
              <th height="30"><span class="word_white">新密码：</span></th>
              <td bgcolor="#0e047d"><html:password property="password" size="30"/><html:hidden property="id" value="${sessionScope.managerform.id}"/></td>
            </tr>
		    <tr>
              <th height="30"><span class="word_white">确认密码：</span></th>
              <td bgcolor="#0e047d"><input name="newPassword" type="password" size="30"><html:hidden property="managerLevel" value="${sessionScope.managerform.managerLevel}"/></td>
            </tr>
          </table>
		  <br>           
