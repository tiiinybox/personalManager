	   ...
	   <html:form action="train.do?method=saveTrain" onsubmit="return checkEmptyForm(trainForm)">          
            <table width="355" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#0e047d">			
              <tr>
                ...
                <td width="263" bgcolor="#0e047d"><html:text property="tn_man" title="请输入培训人名称" size="40"/></td>
              </tr>
              <tr>
                <th height="30"><span class="word_white">培训主题：</span></th>
                <td bgcolor="#0e047d"><html:text property="tn_title" title="请输入培训主题" size="40"/></td>
              </tr>
              <tr>
                <th height="30"><span class="word_white">培训宗旨：</span></th>
                <td bgcolor="#0e047d"><html:text property="tn_content" title="请输入培训宗旨" size="40"/></td>
              </tr>
			    <tr>
                <th height="30"><span class="word_white">培训时间：</span></th>
                <td bgcolor="#0e047d"><html:text property="tn_time" title="请输入培训时间" size="40"/></td>
              </tr>
			    <tr>
                <th height="30"><span class="word_white">培训地点：</span></th>
                <td bgcolor="#0e047d"><html:text property="tn_address" title="请输入培训地点" size="40"/></td>
              </tr>
			    <tr>
                <th height="30"><span class="word_white">参加人员：</span></th>
                <td bgcolor="#0e047d"><html:text property="tn_join" title="请输入参见人员" size="40"/></td>
              </tr>
			  <tr>
                <th height="30"><span class="word_white">备注信息：</span></th>
                <td bgcolor="#0e047d"><html:textarea property="tn_bz" title="请输入备注信息" rows="10" cols="35"  styleClass="textarea" /></td>
              </tr>			  
            </table><br>         
