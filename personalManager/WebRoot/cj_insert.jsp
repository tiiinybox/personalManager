      ...
      <table width="801" height="436" border="0" cellpadding="0" cellspacing="0" background="images/center2.jpg">
        <tr>
          <td height="436" valign="top" align="center">           <html:form action="cj.do?method=saveCj" onsubmit="return checkEmptyForm(cjForm)">          
            <table width="436" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#0e047d" height="421">
              <tr>
                <th width="79" height="30"><span class="word_white">奖惩标题：</span></th>
                <td width="263" bgcolor="#0e047d"><html:text property="cj_title" title="奖惩题目"/></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td bgcolor="#0e047d"><html:text property="cj_money" title="请输入奖惩金额"/></td>
              </tr>
              <tr>
                <th height="30"><span class="word_white">奖惩时间：</span></th>
                <td bgcolor="#0e047d"><html:text property="cj_time" title="请输入奖惩日期"/></td>
              </tr>
              <tr>
                <th height="30"><span class="word_white">奖惩原因：</span></th>
                <td bgcolor="#0e047d"><html:textarea property="cj_content" title="请输入奖惩理由" rows="10" cols="35"  styleClass="textarea" /></td>
              </tr>
            </table><br>   
