      ...
      <table width="801" height="436" border="0" cellpadding="0" cellspacing="0" background="images/center2.jpg">
        <tr>
          <td height="436" valign="top" align="center">                  
            <table width="355" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#12025b">
              <tr>
                <th width="79" height="30"><span class="word_white">奖惩题目：</span></th>
                <td width="263" bgcolor="#0e047d">${requestScope.cjForm.cj_title}</td>
              </tr>
              <tr>
                <th height="30"><span class="word_white">奖惩类型：</span></th>
                <td bgcolor="#0e047d">${requestScope.cjForm.cj_type}</td>
              </tr>
              <tr>
                <th height="30"><span class="word_white">奖惩金额：</span></th>
                <td bgcolor="#0e047d">${requestScope.cjForm.cj_money}</td>
              </tr>
              <tr>
                <th height="30"><span class="word_white">奖惩时间：</span></th>
                <td bgcolor="#0e047d">${requestScope.cjForm.cj_time}</td>
              </tr>
              <tr>
                <th height="30"><span class="word_white">奖惩理由：</span></th>
                <td bgcolor="#0e047d">${requestScope.cjForm.cj_content}</td>
              </tr>
            </table><br>   
