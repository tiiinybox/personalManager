  ...
  <tr>
    <td align="center">
      ...
      <table width="801" height="436" border="0" cellpadding="0" cellspacing="0" background="images/center2.jpg">
        ...
        %>
         <table width="650" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#0e047d">
            <tr align="center">
        ...
        <logic:iterate id="trainForm" collection="<%=list%>"  indexId="number">
           <bean:define id="id" name="trainForm" property="id"/>
            <tr align="center" bgcolor="#FFFFFF">           
              ...
              <td bgcolor="#0e047d"><a href="train.do?method=queryOneTrain&id=<%=id%>">查看详细信息</a>&nbsp;&nbsp; <a href="javascript:deleteForm('<%=id%>')">删除</a></td>
            </tr>
         </logic:iterate>
          </table>
           <table width="650">
