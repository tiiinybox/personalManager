        ...
        <tr>
          <td height="436" valign="top" align="center">        
		   <html:form action="pay.do?method=savePay">          
            <table width="355" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#0e047d">
              <tr>
                <th width="87" height="30"><span class="word_white">编号及姓名：</span></th>
                <td width="255" bgcolor="#0e047d">
              ...
              <tr>
                ...
                <td bgcolor="#0e047d"><html:text property="pay_month" value="<%=getSystemTime.getYearMonth()%>" readonly="readonly" onclick="alert('此文本框已设为只读，用户不能修改')"/></td>
              </tr>
              <tr>
                <th height="30"><span class="word_white">基本工资：</span></th>
                <td bgcolor="#0e047d"><html:text property="pay_baseMoney" title="请输入基本工资"/></td>
              </tr>
			  <tr>
                <th height="30"><span class="word_white">加班次数：</span></th>
                <td bgcolor="#0e047d"><html:text property="pay_overtime" title="请输入加班次数"/></td>
              </tr>
			   <tr>
                <th height="30"><span class="word_white">工龄：</span></th>
                <td bgcolor="#0e047d"><html:text property="pay_age" title="请输入工龄"/></td>
              </tr>
			  <tr>
                <th height="30"><span class="word_white">全勤奖：</span></th>
                <td bgcolor="#0e047d"><html:text property="pay_check" title="请输入全勤奖"/></td>
              </tr>
			  <tr>
                <th height="30"><span class="word_white">旷工费：</span></th>
                <td bgcolor="#0e047d"><html:text property="pay_absent" title="请输入旷工费"/></td>
              </tr>
			  <tr>
                <th height="30"><span class="word_white">保险费：</span></th>
                <td bgcolor="#0e047d"><html:text property="pay_safety" title="请输入保险费"/></td>
              </tr>
            </table><br>         
