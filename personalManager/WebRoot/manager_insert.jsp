      ...
      <table width="801" height="436" border="0" cellpadding="0" cellspacing="0" background="images/center2.jpg">
        <tr>
		 ...
		 <html:form action="manager.do?method=insertManager" onsubmit="return insertManager()">
		  <table width="265" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#0e047d">
            <tr>
              <th width="70" height="30"><div align="right" class="word_white">账号：</div></th>
              <td width="183" bgcolor="#0e047d"><html:text property="account"/></td>
            </tr>
            <tr>
              <th height="30"><div align="right" class="word_white">密码：</div></th>
              <td bgcolor="#0e047d"><html:password property="password"/></td>
            </tr>
             <tr>
              <th height="30"><div align="right" class="word_white">确认密码：</div></th>
              <td bgcolor="#0e047d"><input type="password" name="newPassword"></td>
            </tr>
            <tr>
              <th height="30"><div align="right" class="word_white">级别：</div></th>
              <td bgcolor="#0e047d"><html:hidden property="managerLevel" value="0"/>普通</td>
            </tr>
          </table>
		  <br>           
